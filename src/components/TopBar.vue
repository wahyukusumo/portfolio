<template>
  <nav
    class="hidden lg:grid grid-cols-3 px-8 bg-gray-200/30 dark:bg-black/30 p-1 z-40 top-0 left-0 right-0 fixed text-sm font-medium dark:text-white font-sfpro backdrop-blur-sm shadow-md">
