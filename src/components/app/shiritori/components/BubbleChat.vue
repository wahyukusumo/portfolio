...
<template>
  ...
  <!-- Score -->
  <small v-if="game"
    class="flex flex-row justify-center items-center gap-1 font-bold -mt-3 text-gray-500 dark:text-gray-200"
...
export default {
  data() {
    return {
      ...
      fromClass: { 'me': 'bg-violet-300 dark:bg-violet-600 rounded-bl-2xl self-end', 'bot': 'bg-gray-200 dark:bg-gray-500 rounded-br-2xl self-start' },
    };
  },
  methods: {
    imgSrc(image) {
