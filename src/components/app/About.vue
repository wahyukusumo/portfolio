    ...
    <div class="flex flex-col" :class="{ 'md:grid-cols-1': this.isFull }">
      <Card class="flex flex-col justify-center items-center py-5 h-full lg:border-b-0">
        ...
        <div class="bg-[url('@/assets/profile/avatar.webp')] bg-center bg-cover w-full z-10"
          :class="{ 'xl:h-[20vh] 2xl:h-[30vh]': this.isFull, 'xl:h-[20vh]': !this.isFull }"></div>

        <!-- Info Container -->
        <div class="flex justify-center flex-col items-center" :class="{
          'xl:absolute xl:mt-[45vh]': this.isFull,
          'xl:absolute xl:mt-[43vh]': !this.isFull
        }">
          <!-- Profile image -->
          <div
          ...
          <!-- About -->
          <p class="my-6 text-center z-20" :class="{ 'relative mx-[60vh]': this.isFull }"
            v-html="appdata.profile.about.en"></p>

          <!-- Contact -->
          <div :class="{
            'flex gap-4': this.isFull,
            'flex flex-wrap gap-4 justify-center mt-5': !this.isFull
          }">
            <div
