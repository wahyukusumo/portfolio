<template>
  <div ref="draggableContainer" :id="`${appName.toLowerCase()}-window`" @mousedown="this.$emit('appID', this.$refs.draggableContainer.id)"
    ...
    <!-- App Navbar -->
    <div @mousedown="dragMouseDown" class="bg-white relative w-full border-b border-gray-300
  dark:border-black p-2 grid grid-cols-3 text-xl dark:bg-[#231d26] dark:text-white"
    ...
    <div class="relative p-5 lg:rounded-b-xl border-t border-gray-300 dark:border-black bg-white dark:bg-[#231d26] dark:text-white">
    </div>
